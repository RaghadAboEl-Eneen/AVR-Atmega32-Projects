...
//choose 0 for input and 1 for output.
 ...
 #define PORTB_PIN4_DIR 	0 //SS slave select input floating
 #define PORTB_PIN5_DIR 	0 //MOSI slave input
 #define PORTB_PIN6_DIR 	1 //MISO slave output
 #define PORTB_PIN7_DIR 	0 //SCK:input to read clock
