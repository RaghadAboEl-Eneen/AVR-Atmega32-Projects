...
//choose 0 for input and 1 for output.
 ...
 #define PORTB_PIN4_DIR 	0   //SS input PullUp
 #define PORTB_PIN5_DIR 	1	//MOSI set as output
 #define PORTB_PIN6_DIR 	0	//MISO set as input
 #define PORTB_PIN7_DIR 	1	//Clock generation pin SCK set as output
