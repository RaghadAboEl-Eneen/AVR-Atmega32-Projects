...
u8 CLCD_u8ReadCurrentAddress(void) {

	u8 Local_AddressContent;

	DIO_u8SetPinValue(CLCD_CONTROL_PORT, CLCD_RS_PIN, DIO_u8PIN_LOW);
	DIO_u8SetPinValue(CLCD_CONTROL_PORT, CLCD_RW_PIN, DIO_u8PIN_HIGH);
	Local_AddressContent = CLCD_DATA_PORT;

	return Local_AddressContent;

}

u8 CLCD_ReadAddressContent(void) {
